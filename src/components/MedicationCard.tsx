    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative">
      <Card className="w-full max-w-3xl shadow-lg border border-gray-200 rounded-3xl overflow-hidden bg-white">
        <CardContent className="p-8 text-center space-y-8">
          ...
          {/* Action buttons with same height and no icons */}
          <div className="space-y-4">
            <Button
              onClick={onMedicationTaken}
              disabled={isSendingNotifications}
              className="w-full h-20 bg-green-600 hover:bg-green-700 text-4xl font-bold rounded-2xl shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl disabled:opacity-70 text-white"
            >
